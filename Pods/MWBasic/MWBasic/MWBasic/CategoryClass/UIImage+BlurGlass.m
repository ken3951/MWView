...
- (UIImage *)mw_imgWithBlur
{
    return [self mw_imgWithLightAlpha:0.1 radius:10 colorSaturationFactor:1];
}

- (UIImage *)mw_imgWithLightAlpha:(CGFloat)alpha radius:(CGFloat)radius colorSaturationFactor:(CGFloat)colorSaturationFactor
{
