...
public extension UIImageView {
    // default is nil
    func mw_image(_ value: UIImage?) -> Self {
        image = value
        return self
    }
    
    func mw_contentMode(_ value: UIView.ContentMode) -> Self {
        contentMode = value
        return self
    }
    ...
    // default is nil
    @available(iOS 3.0, *)
    func mw_highlightedImage(_ value: UIImage?) -> Self {
    ...
    func mw_animationImages(_ value: [UIImage]?) -> Self {
    ...
    // The array must contain UIImages. Setting hides the single image. default is nil
    @available(iOS 3.0, *)
    func mw_highlightedAnimationImages(_ value: [UIImage]?) -> Self {
        highlightedAnimationImages = value
        return self
    }
    
    // for one cycle of images. default is number of images * 1/30th of a second (i.e. 30 fps)
    func mw_animationDuration(_ value: TimeInterval) -> Self {
        animationDuration = value
        return self
    }
    
    // 0 means infinite (default is 0)
    func mw_animationRepeatCount(_ value: Int) -> Self {
