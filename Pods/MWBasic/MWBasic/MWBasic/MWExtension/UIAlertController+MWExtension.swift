...
//MARK:--显示dialog弹窗
public func mw_showAlert(message: String , buttonItems : Array<String> = ["确定"] , indexBlock : IntCallBack? = nil) {
...
public func mw_showActionSheet(title: String?, message: String?, buttonItems : Array<String> = ["确定"] , indexBlock : IntCallBack? = nil) {
    DispatchQueue.main.async {
